...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Driver driver1 = new Driver(null, "Luan Dias", 111111, 111111, 111111, LocalDate.of(2002, 02, 17));
		Driver driver2 = new Driver(null, "Felipe Santos", 222222, 222222, 222222, LocalDate.of(1994, 06, 20));
		Driver driver3 = new Driver(null, "Paulo Jose", 333333, 333333, 333333, LocalDate.of(1986, 11, 01));
